...
var galleryList = document.querySelector('ul.js-gallery');
var lightbox = document.querySelector('.js-lightbox');
var overlay = document.querySelector('.lightbox__overlay');
var lightboxImgEl = document.querySelector('img.lightbox__image');
var btnCloseEl = document.querySelector('button[data-action="close-lightbox"]');
var galleryMarkup = makeGalleryMarkup(_galleryItems.default);
...
var arrGalleryList = galleryList.querySelectorAll('.gallery__image');

var arrGalleryListCopy = _toConsumableArray(arrGalleryList);
...
function lightboxImageMove(step) {
  var currentIndex = Number(lightboxImgEl.dataset.index);
  var afterStepIndex = currentIndex + step;
...
},{"./sass/main.scss":"sass/main.scss","./js/gallery-items":"js/gallery-items.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
